      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1 mt-1.5 md:hidden">
            {service.tags?.slice(0, 2).map((tag) => (
              <span key={tag} className="px-1.5 py-0.5 bg-[#f8fafc] rounded text-[9px] text-[#64748b]">
                {tag}
              </span>
            ))}
          </div>
        ...
        {!bulkMode && (
          <button
            ...
            className="md:hidden w-8 h-8 rounded-lg bg-[#f8fafc] flex items-center justify-center text-[#64748b]"
          >

      ...
      >
        ...
        >
            ...
            <div className="flex justify-between items-start gap-3">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {booking.verified && (
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                <button
                  ...
                  className="sm:hidden w-9 h-9 rounded-full bg-[#f8fafc] text-[#64748b] flex items-center justify-center hover:bg-[#8b5cf6] hover:text-white transition-all"
                >
                  <i className="fas fa-ellipsis-v text-sm" />
                </button>
                <button
                  onClick={handleDelete}
                  className="w-9 h-9 rounded-full bg-[#f8fafc] text-[#64748b] flex items-center justify-center hover:bg-[#ef4444] hover:text-white transition-all active:scale-95"
                  title="Delete"
                >
                ...
                <button
                  onClick={onClose}
                  className="w-9 h-9 rounded-full bg-[#f8fafc] text-[#64748b] flex items-center justify-center hover:bg-[#8b5cf6] hover:text-white transition-all active:scale-95"
                >
          ...
          <div className="flex-1 overflow-y-auto px-5 md:px-6 py-4 md:py-5 space-y-5 md:space-y-6">
            {/* Client Card */}
            <div className="bg-gradient-to-br from-[#ede9fe] to-[#f5f3ff] rounded-xl md:rounded-2xl p-4 md:p-5 border border-[#8b5cf6]/10">
              <div className="flex items-center gap-3 md:gap-4 mb-4">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-[#8b5cf6] to-[#7c3aed] text-white flex items-center justify-center font-bold text-lg md:text-xl shrink-0 relative shadow-md shadow-[#8b5cf6]/20">
                ...
                <div className="min-w-0">
                  <div className="font-extrabold text-base md:text-lg text-[#1e293b] truncate">
                    {booking.client}
                  </div>
            ...
            <div>
              ...
              <div className="bg-[#f8fafc] rounded-xl md:rounded-2xl p-4 md:p-5 border border-[#e2e8f0] space-y-3">

      ...
      >
        ...
        >
            ...
            <div className="flex justify-between items-start gap-3">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                <button
                  ...
                  className="sm:hidden w-9 h-9 rounded-xl bg-[#F8FAFC] text-[#64748B] flex items-center justify-center hover:bg-[#8B5CF6] hover:text-white transition-all"
                >
                  <i className="fas fa-ellipsis-v text-sm" />
                </button>
                <button
                  onClick={handleDelete}
                  className="w-9 h-9 rounded-xl bg-[#F8FAFC] text-[#64748B] flex items-center justify-center hover:bg-[#EF4444] hover:text-white transition-all active:scale-95"
                  title="Delete"
                >
                ...
                <button
                  onClick={onClose}
                  className="w-9 h-9 rounded-xl bg-[#F8FAFC] text-[#64748B] flex items-center justify-center hover:bg-[#8B5CF6] hover:text-white transition-all active:scale-95"
                >
          ...
          <div className="flex-1 overflow-y-auto px-5 md:px-6 py-4 md:py-5 space-y-5 md:space-y-6">
            {/* Client Card */}
            <div className="bg-gradient-to-br from-[#EDE9FE] to-[#F5F3FF] rounded-2xl p-4 md:p-5 border border-[#8B5CF6]/10">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-white/80 text-[#25D366] rounded-xl font-semibold text-xs md:text-sm hover:bg-[#25D366] hover:text-white transition-all active:scale-95 border border-white/50"
                >
                ...
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-white/80 text-[#475569] rounded-xl font-semibold text-xs md:text-sm hover:bg-[#8B5CF6] hover:text-white transition-all active:scale-95 border border-white/50"
                >
            ...
            {/* Details Grid */}
            <div>
              <h3 className="text-[10px] md:text-xs font-semibold uppercase tracking-wide text-[#94A3B8] mb-3 flex items-center gap-2">
            ...
            <div>
              ...
              <div className="bg-[#F8FAFC] rounded-2xl p-4 md:p-5 border border-[#E2E8F0] space-y-3">
                <div className="flex justify-between items-center pb-3 border-b border-[#E2E8F0]">
                  <span className="text-sm text-[#64748B]">Total Price</span>
                  <span className="font-bold text-lg md:text-xl text-[#8B5CF6]">{formatCurrency(booking.price)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B]">Deposit Paid</span>
                  <span className="font-semibold text-[#10B981]">{formatCurrency(booking.deposit || 0)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#64748B]">Balance Due</span>
                  <span className={`font-semibold ${balanceDue > 0 ? "text-[#D97706]" : "text-[#10B981]"}`}>
            ...
            {booking.paymentProof && (
              <div>
                <h3 className="text-[10px] md:text-xs font-semibold uppercase tracking-wide text-[#10B981] mb-3 flex items-center gap-2">
                  <i className="fas fa-check-circle" />
                  Payment Confirmed
                </h3>
                <div className="bg-gradient-to-br from-[#F0FDF4] to-[#ECFDF5] rounded-2xl p-4 md:p-5 border border-[#10B981]/20 space-y-3">

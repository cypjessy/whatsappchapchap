...
export default function BookingListView({
  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-xl md:rounded-2xl border border-[#e2e8f0] overflow-hidden shadow-sm">
        <div className="hidden md:grid grid-cols-[2fr_1.5fr_1fr_1fr_1fr_auto] gap-4 px-6 py-3 bg-white border-b border-[#e2e8f0]">
  ...
  return (
    <div className="bg-white rounded-xl md:rounded-2xl border border-[#e2e8f0] overflow-hidden shadow-sm">
      {/* Desktop Header */}
      <div className="hidden md:grid grid-cols-[2fr_1.5fr_1fr_1fr_1fr_auto] gap-4 px-6 py-3 bg-white border-b border-[#e2e8f0] sticky top-0 z-10">
        <SortHeader
...
<style jsx global>{`
  @media (max-width: 768px) {
    ...
    /* MD3 Customer Name */
    .text-sm.font-medium.text-gray-900 { color: var(--md-sys-color-on-surface, #1e293b) !important; font-size: 15px !important; }
    
    /* MD3 Phone Number */
    .text-xs.text-gray-500 { color: var(--md-sys-color-on-surface-variant, #64748b) !important; font-size: 13px !important; }
    ...
    /* MD3 Price Display */
    .font-bold.text-gray-900 { color: var(--md-sys-color-primary, #8b5cf6) !important; font-weight: 600 !important; font-size: 16px !important; }

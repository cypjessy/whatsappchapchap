...
export default function BookingFilters({
  ...
  return (
    <div className="bg-white rounded-xl md:rounded-2xl border border-[#e2e8f0] overflow-hidden mb-6 shadow-sm">
      ...
      <div className="p-3 md:p-4">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <button
            ...
            className={`
              md:hidden flex items-center justify-center w-10 h-10 rounded-xl border-2 shrink-0
              transition-all duration-200 active:scale-95
              ${isExpanded
                ? "border-[#8b5cf6] bg-[#8b5cf6] text-white"
                : "border-[#e2e8f0] bg-[#f8fafc] text-[#64748b] hover:border-[#8b5cf6] hover:text-[#8b5cf6]"
              }
            `}
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2.5 rounded-xl border-2 border-[#ef4444]/30 text-[#ef4444] hover:bg-[#ef4444] hover:text-white hover:border-[#ef4444] transition-all duration-200 active:scale-95 text-sm font-semibold shrink-0"
              >
        ...
        `}>
          <div className="space-y-2.5 pt-2 border-t border-[#e2e8f0]">
            ...
            {hasActiveFilters && (
              <button
                onClick={clearAllFilters}
                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 border-[#ef4444]/30 text-[#ef4444] hover:bg-[#ef4444] hover:text-white hover:border-[#ef4444] transition-all duration-200 active:scale-95 text-sm font-semibold"
              >
                <i className="fas fa-times text-xs" />
                Clear All Filters
              </button>
      ...
      {activeFilters.length > 0 && (
        <div className="px-3 md:px-4 pb-3 md:pb-4">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[10px] md:text-xs font-semibold text-[#94a3b8] uppercase tracking-wider mr-1">
              Active:
            </span>

    ...
    >
      <div className="py-1">
        {ALL_STATUSES.map((s) => (
          <button
            key={s.value}
            className={`w-full px-4 py-3 text-sm flex items-center gap-3 hover:bg-[#f8fafc] transition-colors text-left ${
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin">
            <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr]">
              ...
              <div className="p-4 md:p-6 lg:border-r border-[#e2e8f0]">
                ...
                <div className="lg:hidden space-y-3 mb-6">
                  {order.products && order.products.length > 0 ? (
                    order.products.map((product, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-3 p-3 bg-[#f8fafc] rounded-xl border border-[#e2e8f0] hover:border-[#25D366]/30 transition-all"
                      >
                    ...
                    <div className="text-center text-[#64748b] py-8 bg-gray-50 rounded-xl">No items</div>
                  )}
                </div>
                  ...
                  <div className="border border-[#e2e8f0] rounded-xl overflow-hidden">
                    <table className="w-full border-collapse">
                      ...
                      <tbody>
                        {order.products && order.products.length > 0 ? (
                          order.products.map((product, idx) => (
                            <tr key={idx} className="border-t border-[#e2e8f0] hover:bg-[#f8fafc] transition-colors">
                ...
                {/* Order Summary */}
                <div className="bg-[#f8fafc] rounded-xl p-5 border border-[#e2e8f0] mb-6 animate-fadeIn" style={{ animationDelay: '0.1s' }}>
              ...
              {/* ─── Right Column ─── */}
              <div className="p-4 md:p-6 bg-[#f8fafc] lg:bg-transparent animate-fadeIn" style={{ animationDelay: '0.2s' }}>
                {/* Customer Info */}
            ...
            <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-3">
              ...
              <div className="flex gap-2 order-2 md:order-1">
                <ActionButton
                  ...
                  label="Invoice"
                  color="bg-[#f8fafc] border border-[#e2e8f0] text-[#64748b] hover:border-blue-400 hover:text-blue-500"
                ...
                <ActionButton
                  icon="fa-receipt"
                  label="Receipt"
                  color="bg-[#f8fafc] border border-[#e2e8f0] text-[#64748b] hover:border-[#25D366] hover:text-[#25D366]"
              ...
              <div className="flex gap-2 order-1 md:order-2 flex-wrap">
                ...
                <div className="relative md:hidden flex-1">
                  <button
                    className="w-full px-4 py-2.5 bg-[#f8fafc] border-2 border-[#e2e8f0] rounded-xl font-semibold text-sm hover:border-[#25D366] transition-all flex items-center justify-center gap-2"
                    onClick={() => setShowStatusMenu(!showStatusMenu)}
                  >

          ...
          {showMenu && (
            <div className="absolute top-full right-0 mt-1 bg-white rounded-xl shadow-xl border border-[#e2e8f0] min-w-[180px] overflow-hidden z-50 animate-fadeIn">
              {BULK_ACTIONS.map((action) => (
                <button
                  key={action.status}
                  className="w-full px-4 py-2.5 text-sm flex items-center gap-3 hover:bg-[#f8fafc] transition-colors text-left text-[#1e293b]"
                  onClick={() => {
...
export default function OrderTable({
  ...
  if (isLoading) {
    return (
      <div className="hidden md:block overflow-x-auto rounded-xl border border-[#e2e8f0] animate-fadeIn">
  ...
  return (
    <div className="hidden md:block animate-fadeIn">
      ...
      {/* Table */}
      <div className="overflow-x-auto rounded-xl border border-[#e2e8f0] shadow-sm animate-slideDown">
        <table className="w-full min-w-[800px]">
          <thead>
            <tr className="bg-[#f8fafc] sticky top-0 z-10 animate-fadeIn">

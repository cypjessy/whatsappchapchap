...
function RequestCard({
  ...
  return (
    ...
    >
      ...
      {/* Processed Badge */}
      {request.status !== "pending" && (
        <div className="flex items-center justify-center gap-2 py-2 text-xs font-medium text-gray-400 bg-white rounded-lg">
                ...
                <button
                  ...
                  className={`px-3 sm:px-4 py-2 rounded-xl font-semibold text-sm whitespace-nowrap transition-all duration-200 flex items-center gap-2 flex-shrink-0 active:scale-95 ${
                    isActive
                      ...
                      : "bg-white border-2 border-[#e2e8f0] text-[#64748b] hover:bg-white"
                  }`}
                  style={
                    isActive
                      ? {

    ...
    <div className="fixed inset-0 z-[2500] flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-slideUp">
        <div className="w-14 h-14 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-4">
          <i className="fas fa-exclamation-triangle text-2xl text-gray-500" />
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2.5 mb-4">
        <div className="flex items-center gap-2.5 text-[#64748b] bg-gray-50 p-2.5 rounded-lg text-sm">
            ...
            <i
              className={`fas ${
                request.status === "approved"
                  ...
                  : "fa-comment-slash text-gray-600"
      ...
      {/* Processed Badge */}
      {request.status !== "pending" && (
        <div className="flex items-center justify-center gap-2 py-2 text-xs font-medium text-gray-400 bg-gray-50 rounded-lg">
    ...
    <div className="animate-fadeIn">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4 animate-fadeIn" style={{ animationDelay: '0.1s' }}>
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20 transition-all placeholder:text-gray-400"
            />
            {searchQuery && (
              <button
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2.5 bg-white border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20 transition-all appearance-none cursor-pointer"
            >
                ...
                <button
                  ...
                  className={`px-3 sm:px-4 py-2 rounded-xl font-semibold text-sm whitespace-nowrap transition-all duration-200 flex items-center gap-2 flex-shrink-0 active:scale-95 ${
                    isActive
                      ...
                      : "bg-white border-2 border-[#e2e8f0] text-[#64748b] hover:bg-gray-50"
                  }`}
                  style={
                    isActive
                      ? {
      ...
      {!isLoading && filteredRequests.length > 0 && (
        <div className="flex items-center justify-between mb-4 px-1 animate-fadeIn" style={{ animationDelay: '0.2s' }}>
          <p className="text-sm text-[#64748b]">
            Showing <span className="font-semibold text-[#1e293b]">{filteredRequests.length}</span>{" "}

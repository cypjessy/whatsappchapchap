...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 rounded-xl bg-gradient-to-br from-[${iconColor}]/5 to-transparent pointer-events-none transition-opacity duration-300 hidden md:block ${
...
export default function OrderStats({
  ...
  return (
    <div className="mb-4 md:mb-6 animate-fadeIn">
      {/* Stats Grid */}
      <div className="grid grid-cols-2 md:flex md:overflow-x-auto md:pb-3 md:scrollbar-hide gap-2 md:gap-3 -mx-1 px-1 animate-fadeIn" style={{ animationDelay: '0.1s' }}>

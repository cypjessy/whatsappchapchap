    ...
    <>
      ...
      <div className="fixed inset-0 z-[2500] flex items-center justify-center p-3 sm:p-4 pointer-events-none overflow-y-auto">
        ...
        >
              ...
              <div className="space-y-6">
                    ...
                    <div className="max-h-52 overflow-y-auto scrollbar-thin">
                      {filteredProducts.length === 0 ? (
                        ...
                        filteredProducts.map((product) => (
                          <div
                            key={product.id}
                            className="flex items-center gap-3 p-3 border-b border-[#e2e8f0] last:border-b-0 hover:bg-[#f8fafc] transition-colors group"
                          >
                  ...
                  <div className="animate-fadeIn" style={{ animationDelay: '0.15s' }}>
                    ...
                    <div className="space-y-2">
                      {form.selectedProducts.map((item) => (
                        <div
                          key={item.productId}
                          className="flex items-center gap-3 p-3 bg-[#f8fafc] rounded-xl border border-[#e2e8f0] hover:border-[#25D366]/30 transition-all group"
                        >
                ...
                {form.selectedProducts.length > 0 && (
                  <div className="animate-fadeIn" style={{ animationDelay: '0.2s' }}>
                    ...
                    <div className="bg-[#f8fafc] rounded-xl p-4 space-y-2 border border-[#e2e8f0]">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-3 p-4 rounded-xl border-2 transition-all text-left ${
                          form.paymentMethod === method.id
                            ...
                            : "border-[#e2e8f0] hover:border-[#25D366]/50 hover:bg-gray-50"
                        }`}
                      >
                        <div
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                          activeDeliveryType === type
                            ? "bg-[#25D366] text-white shadow-md"
                            : "bg-[#f8fafc] text-[#64748b] hover:bg-gray-100"
                        }`}
                      >
                        {type}
                      </button>
          ...
          {/* Footer */}
          <div className="flex-shrink-0 p-3 sm:p-4 border-t border-[#e2e8f0] bg-[#f8fafc] animate-fadeIn" style={{ animationDelay: '0.5s' }}>

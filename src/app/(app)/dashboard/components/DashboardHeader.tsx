      ...
      <div className="relative flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[10px] font-bold uppercase tracking-wider text-white/70 bg-white/10 px-2 py-0.5 rounded-full">
              {currentTime}
            </span>
          </div>
          ...
          <p className="text-white/80 text-sm font-medium truncate">{tenantName}</p>
        ...
        {/* Avatar */}
        <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center font-bold text-lg shrink-0 border-2 border-white/30">
    ...
    >
      ...
      {showBreadcrumb && (
        <nav className="flex items-center gap-2 text-sm text-[#94a3b8] mb-3">
          <span className="hover:text-[#64748b] cursor-pointer transition-colors">Home</span>
      ...
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl lg:text-[1.875rem] font-extrabold text-[#1e293b] tracking-tight">
            Good {greeting},{" "}
        ...
        <div className="text-right shrink-0 ml-4">
          <div className="text-2xl font-extrabold text-[#1e293b] tabular-nums">

    ...
    <div className="bg-gradient-to-br from-[rgba(139,92,246,0.08)] to-[rgba(124,58,237,0.03)] rounded-xl md:rounded-2xl p-4 md:p-6 mb-4 md:mb-6 border border-[rgba(139,92,246,0.1)]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <button className="flex-1 md:flex-none px-3 md:px-4 py-2 bg-surface border-2 border-outline-variant rounded-xl font-semibold text-sm hover:border-[#8b5cf6] transition-colors">

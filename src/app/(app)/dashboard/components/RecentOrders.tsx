    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className={`
          ...
          bg-gradient-to-b ${order.productEmojiBg || "from-[#f1f5f9] to-[#e2e8f0]"}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            <span className="font-bold text-sm text-[#25D366]">#{order.id}</span>
            <span className="font-extrabold text-sm">{formatCurrency(order.amount || 0)}</span>
          </div>
    ...
    >
      ...
      <td className="p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="font-bold text-sm truncate">{order.productName}</div>
      ...
      <td className="p-4">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#ede9fe] to-[#e0e7ff] flex items-center justify-center text-[10px] font-bold text-[#8b5cf6]">
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-12 md:py-16 text-[#64748b] animate-fadeIn">
      <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-[#f1f5f9] to-[#e2e8f0] flex items-center justify-center mb-4 shadow-inner">
        <i className="fas fa-shopping-bag text-2xl md:text-3xl text-[#cbd5e1]" />
      </div>
      <h4 className="font-bold text-base md:text-lg text-[#475569] mb-1">No orders yet</h4>
      ...
      <Link
        ...
        className={`
          ...
          bg-[#f5f3ff] text-[#8b5cf6] border-2 border-[#ede9fe]
    ...
    `}>
      ...
      <div className="p-4 md:p-5 border-b border-[#e2e8f0] flex items-center justify-between bg-gradient-to-r from-white to-[#f8fafc]">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="font-bold text-sm md:text-base text-[#1e293b]">Recent Orders</h3>
              ...
              <thead className="sticky top-0 z-10">
                <tr className="bg-[#f8fafc] border-b border-[#e2e8f0]">
                  {["Order ID", "Product", "Customer", "Amount", "Status", "Date"].map((h) => (
                    <th key={h} className="text-left p-4 text-[11px] font-bold uppercase tracking-wider text-[#64748b]">
                      {h}
                    </th>
                  ))}
                </tr>

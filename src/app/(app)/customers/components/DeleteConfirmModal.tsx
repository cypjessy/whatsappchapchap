...
function CustomerPreview({ customer }: { customer: Customer }) {
  return (
    <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-[#e2e8f0] mb-4">
      <div className={`
  ...
  return (
    ...
    >
      ...
      >
              ...
              <input
                ...
                className={`
                  ...
                  ${confirmText.toLowerCase().trim() === expectedText.toLowerCase().trim()
                    ...
                    : "border-[#e2e8f0] bg-white text-[#1e293b] focus:border-[#ef4444]"
                  }
        ...
        {/* Actions */}
        <div className="p-4 md:p-6 border-t border-[#e2e8f0] bg-white flex justify-end gap-2.5 md:gap-3">
          <button
            onClick={handleClose}
            disabled={isDeleting}
            className={`

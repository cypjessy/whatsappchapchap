...
export default function CustomerFilterBottomSheet({
  ...
  return (
    <>
      ...
      {/* Bottom Sheet */}
      <div
        className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-[70] max-h-[85vh] overflow-y-auto animate-slideUp lg:hidden shadow-2xl"
        role="dialog"
        aria-modal="true"
        aria-label="Customer filters"
      >
        {/* Handle bar */}
        <div className="sticky top-0 bg-white pt-3 pb-2 px-4 border-b border-[#e2e8f0] z-10">
          <div className="w-10 h-1 bg-[#cbd5e1] rounded-full mx-auto mb-3" />
          <h2 className="text-lg font-bold text-[#1e293b] text-center">Filters</h2>
        </div>
        ...
        <div className="p-4 space-y-5">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${localStatus === option.value
                      ...
                      : "bg-[#f8fafc] text-[#64748b] border-2 border-[#e2e8f0] hover:border-[#25D366]"
                    }
                  `}
                >
                  {option.label}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-3 rounded-xl border-2 border-[#e2e8f0] bg-white text-sm font-medium focus:border-[#25D366] focus:outline-none"
            >
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-3 rounded-xl border-2 border-[#e2e8f0] bg-white text-sm font-medium focus:border-[#25D366] focus:outline-none"
              />
          ...
          <div>
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full px-3 py-3 rounded-xl border-2 border-[#e2e8f0] bg-white text-sm font-medium focus:border-[#25D366] focus:outline-none text-[#1e293b]"
              />
              <input
                type="date"
                value={localDateEnd}
        ...
        <div className="sticky bottom-0 bg-white border-t border-[#e2e8f0] p-4 flex gap-3">
          <button
            ...
            className="flex-1 px-4 py-3 rounded-xl border-2 border-[#e2e8f0] text-[#64748b] font-bold text-sm hover:border-[#ef4444] hover:text-[#ef4444] transition-all active:scale-95"
          >
            Clear All
          </button>
          <button

...
function OrderCard({ order, index, formatCurrency }: {
  ...
  return (
    <div className={`
      flex justify-between items-center p-3.5 md:p-4 bg-[#f8fafc] rounded-xl border border-transparent
...
function ActivityItem({ icon, iconColor, iconBg, title, subtitle, time }: {
  ...
  return (
    <div className="flex items-start gap-3 p-3 rounded-xl hover:bg-[#f8fafc] transition-colors group">
      <div className={`
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Actions */}
              <div className="bg-[#f8fafc] rounded-2xl p-4 md:p-5 space-y-2.5">
                <button
              ...
              {/* Contact Info */}
              <div className="bg-[#f8fafc] rounded-2xl p-4 md:p-5 space-y-3">
                {[
              ...
              <div className="bg-white rounded-2xl p-4 md:p-5 border border-[#e2e8f0]">
                ...
                <textarea
                  className={`
                    w-full bg-[#f8fafc] p-3 rounded-xl text-sm text-[#1e293b] 
            ...
            <div className="min-w-0">
              ...
              <div className="min-h-[300px]">
                ...
                {activeTab === "messages" && (
                  <div className="bg-[#f8fafc] rounded-2xl p-6 md:p-8 text-center">
                ...
                {activeTab === "preferences" && (
                  <div className="space-y-4">
                    {/* Tags */}
                    <div className="bg-[#f8fafc] p-4 md:p-5 rounded-2xl border border-[#e2e8f0]">

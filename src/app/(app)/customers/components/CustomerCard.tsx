          ...
          {ACTIONS.map((action) => (
            <button
              ...
              className={`
                ...
                hover:bg-[#f8fafc] transition-colors text-left
              `}
            >
...
export default function CustomerCard({
  ...
  return (
    ...
    >
      ...
      {/* Stats */}
      <div className="grid grid-cols-3 gap-2 mb-3 md:mb-4 p-2.5 md:p-3 bg-[#f8fafc] rounded-xl border border-[#e2e8f0]/50">
        <StatCard
      ...
      <div className="space-y-1.5 md:space-y-2 mb-3 md:mb-4">
        <div className="flex items-center gap-2 text-xs md:text-sm text-[#64748b]">
          <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg bg-[#f8fafc] flex items-center justify-center shrink-0">

...
export default function ProductsHeader({
  ...
  return (
    <header
      ...
      `}
    >
      <div className="max-w-7xl mx-auto px-0 py-3 md:py-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4">
          ...
          <div
            className={`
              flex items-center gap-2 w-full md:w-auto overflow-x-auto hide-scrollbar pb-1 md:pb-0 snap-x snap-mandatory
              transition-all duration-500

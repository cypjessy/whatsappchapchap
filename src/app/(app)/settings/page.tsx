    ...
    <div className="overflow-x-hidden px-3 md:px-6 py-3 md:py-4 pb-2 animate-fadeIn bg-surface">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-7 gap-2 md:gap-3">
          {[
            ...
            >
              ...
              <div className="text-center">
                <span className="block text-xs md:text-sm font-bold leading-tight">{tab.label}</span>
      ...
      {activeTab === "profile" && (
        <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-sm overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-6 pb-6">
            {/* Basic Information */}
          ...
          {/* Save Button */}
          <div className="mt-6 flex justify-end px-4 md:px-6 pb-4 md:pb-6">
            <button

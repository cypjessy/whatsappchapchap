          ...
          <div className="modal-dialog-body space-y-4">
            ...
            {allImages.length > 0 && renderSection("Images", "fa-image", (
              <div className="space-y-2">
                <div className="relative rounded-xl overflow-hidden group cursor-pointer bg-[var(--md-sys-color-surface)] border-2 border-[var(--md-sys-color-outline-variant)]" onClick={() => setLightboxOpen(true)}>
              ...
              <div className="space-y-1.5">
                {product.variants.map((v, i) => (
                  <div key={v.id || i} className="flex items-center justify-between p-2.5 rounded-xl bg-[var(--md-sys-color-surface)] border border-[var(--md-sys-color-outline-variant)] hover:border-indigo-300 dark:hover:border-indigo-700/50 transition-all">
                    <div className="flex items-center gap-2 min-w-0">
                      <div className="w-6 h-6 rounded-lg border-2 border-indigo-300 dark:border-indigo-600 bg-[var(--md-sys-color-surface)] flex items-center justify-center">

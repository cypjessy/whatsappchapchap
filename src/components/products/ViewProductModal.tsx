    ...
    <div className="animate-fadeIn">
      ...
      <div className="flex flex-col gap-4 md:gap-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-[#f8fafc] rounded-xl p-3 md:p-4 border border-[#e2e8f0]">
        ...
        <SectionCard title="Order Page Link" icon="fa-link">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl border-2 border-[#e2e8f0] text-sm bg-[#f8fafc] text-[#64748b]"
      ...
      >
        ...
        >
          ...
          <div className="relative shrink-0 bg-white">
            {/* Main Image */}
            <div className="relative h-56 md:h-72 bg-[#f8fafc] overflow-hidden group">
              {currentImage ? (
                <>
                  <img
                    src={currentImage}
              ...
              <button
                onClick={handleClose}
                className="absolute top-3 right-3 w-9 h-9 rounded-full bg-white/80 backdrop-blur-sm text-[#64748b] flex items-center justify-center hover:bg-white hover:text-[#ef4444] transition-all shadow-md"
              >
            ...
            {/* Info Bar + Thumbnails */}
            <div className="px-4 md:px-6 py-3 border-b border-[#e2e8f0] bg-white">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <h1 className="text-base md:text-xl font-extrabold text-[#1e293b] flex items-center gap-2 flex-wrap">
                    <span className="truncate">{product.name}</span>
                    <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase border shrink-0 ${stockConfig.bg} border-current/20`} style={{ color: stockConfig.color }}>
                      {stockConfig.text}
                    </span>
                  </h1>
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    {product.status === "draft" && (
                      <span className="text-[10px] font-bold uppercase bg-[#f1f5f9] text-[#64748b] px-2 py-0.5 rounded-full">Draft</span>
                    )}
                  </div>
                </div>
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    ...
                    className="px-3 py-2 bg-gradient-to-r from-[#8b5cf6] to-[#7c3aed] text-white rounded-xl font-semibold text-sm shadow-md hover:shadow-lg transition-all flex items-center gap-2 active:scale-95"
                  >
              ...
              {allImages.length > 0 && (
                <div className="flex items-center gap-2 mt-3 overflow-x-auto pb-1">
                    ...
                    <button
                      ...
                      className={`shrink-0 w-14 h-14 rounded-xl overflow-hidden border-2 transition-all duration-200 ${
                        selectedImage === idx
                          ...
                          : "border-[#e2e8f0] hover:border-[#cbd5e1] opacity-70 hover:opacity-100"
                      }`}
                    >
                  ...
                  {allImages.length > 1 && (
                    <span className="shrink-0 text-[10px] text-[#94a3b8] font-medium ml-1">
          ...
          {/* Body */}
          <div className="flex-1 overflow-y-auto p-3 md:p-6 bg-[#f8fafc]/50">

    ...
    <>
      ...
      <header className="login-topbar-root">
        ...
        <div className="login-topbar-container">
          ...
          <button
            className="login-topbar-nav-btn"
            onClick={handleBack}
          ...
          >
            {/* Ripple */}
            {showRipple && (
              <span className="login-topbar-ripple" />
            )}

            {/* Home icon */}
            <svg
              className="login-topbar-nav-icon"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
          ...
          <div className="login-topbar-brand">
            {/* WhatsApp Icon */}
            <div className="login-topbar-icon-wrapper">
              <svg
                viewBox="0 0 24 24"
                className="login-topbar-icon"
                fill="currentColor"
            ...
            {/* Title */}
            <div className="login-topbar-title-group">
              <span className="login-topbar-title">{title}</span>
              {subtitle && (
                <span className="login-topbar-subtitle">{subtitle}</span>
              )}
            </div>
          </div>

          {/* Trailing: Empty spacer for symmetry */}
          <div className="login-topbar-trailing" />
        </div>
      </header>
    </>
  );

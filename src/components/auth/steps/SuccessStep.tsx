  ...
  return (
    <div className="animate-[fadeIn_0.4s_ease] text-center py-12">
      ...
      <div className="flex justify-center gap-4">
        <button className="py-3 px-6 bg-white text-[#1a1a2e] border-2 border-outline-variant rounded-xl font-semibold hover:border-[#25D366] hover:text-[#25D366] transition-all flex items-center gap-2">

...
export default function Step1Account({
  ...
  return (
    <div className="animate-[fadeIn_0.4s_ease]">
      ...
      <p className="text-[#64748b] mb-4 md:mb-6 text-sm md:text-base">Let&apos;s get you started with your account</p>
      ...
      <div className="mb-4">
        ...
        <div className="mt-2 flex items-center gap-2">
          <div className="flex-1 h-1.5 md:h-2 bg-[#e2e8f0] rounded-full overflow-hidden">
            <div
      ...
      <div className="mb-4 md:mb-6">
        <label className="flex items-center gap-3 cursor-pointer select-none group">
          ...
          />
          <span className="text-xs md:text-sm text-[#64748b] group-hover:text-[#1a1a2e] transition-colors">
            I agree to the{" "}

export default function RegisterSidebar({ currentStep }: { currentStep: number }) {
  const steps = [
    { step: 1, title: "Create Account", desc: "Basic information & connect WhatsApp", active: currentStep === 1 },
    ...
    <div className="md:col-span-2 bg-gradient-to-br from-[#25D366] to-[#128C7E] p-8 md:p-12 text-white flex flex-col justify-between">
      <div>
        <div className="flex items-center gap-4 mb-12">
          <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-[#25D366] text-2xl">

    ...
    <div className="hidden lg:flex flex-1 flex-col justify-center items-center p-12 text-white relative">
      <div className="max-w-[500px] text-center">
        <div className="logo-container mb-8">
          ...
          <h1 className="text-[3rem] font-extrabold mb-4 tracking-tight">WhatsApp Chap Chap</h1>
          <p className="text-xl font-medium opacity-90 mb-8 leading-relaxed">
            AI-Powered Sales Automation for WhatsApp Sellers
          </p>
        </div>

        <div className="flex gap-8 justify-center flex-wrap">
          <div className="flex items-center gap-2 text-sm font-semibold bg-white/15 px-5 py-3 rounded-full backdrop-blur-sm">

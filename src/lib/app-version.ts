...
export const APP_VERSION_CODE = 40; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.39"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 42; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.41"; // Must match android/app/build.gradle → versionName

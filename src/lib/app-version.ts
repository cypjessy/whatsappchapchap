...
export const APP_VERSION_CODE = 31; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.30"; // Must match android/app/build.gradle → versionName

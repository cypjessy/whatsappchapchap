...
export const APP_VERSION_CODE = 46; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.45"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 68; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.67"; // Must match android/app/build.gradle → versionName

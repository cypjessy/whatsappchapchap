...
export const APP_VERSION_CODE = 64; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.63"; // Must match android/app/build.gradle → versionName

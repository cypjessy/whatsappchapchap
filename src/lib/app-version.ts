...
export const APP_VERSION_CODE = 67; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.66"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 65; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.64"; // Must match android/app/build.gradle → versionName

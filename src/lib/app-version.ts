...
export const APP_VERSION_CODE = 49; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.48"; // Must match android/app/build.gradle → versionName

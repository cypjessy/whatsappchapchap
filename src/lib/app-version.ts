...
export const APP_VERSION_CODE = 23; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.22"; // Must match android/app/build.gradle → versionName

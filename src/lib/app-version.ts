...
export const APP_VERSION_CODE = 14; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.13"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 27; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.26"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 34; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.33"; // Must match android/app/build.gradle → versionName

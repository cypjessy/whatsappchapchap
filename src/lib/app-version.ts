...
export const APP_VERSION_CODE = 38; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.37"; // Must match android/app/build.gradle → versionName

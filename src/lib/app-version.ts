...
export const APP_VERSION_CODE = 48; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.47"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 55; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.54"; // Must match android/app/build.gradle → versionName

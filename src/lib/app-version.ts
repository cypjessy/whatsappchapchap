...
export const APP_VERSION_CODE = 33; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.32"; // Must match android/app/build.gradle → versionName

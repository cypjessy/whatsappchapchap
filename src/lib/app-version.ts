...
export const APP_VERSION_CODE = 63; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.62"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 44; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.43"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 69; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.68"; // Must match android/app/build.gradle → versionName

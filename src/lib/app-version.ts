...
export const APP_VERSION_CODE = 25; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.24"; // Must match android/app/build.gradle → versionName

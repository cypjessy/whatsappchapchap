...
export const APP_VERSION_CODE = 19; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.18"; // Must match android/app/build.gradle → versionName

...
export const APP_VERSION_CODE = 32; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.31"; // Must match android/app/build.gradle → versionName

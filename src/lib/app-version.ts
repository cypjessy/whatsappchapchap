...
export const APP_VERSION_CODE = 21; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.20"; // Must match android/app/build.gradle → versionName

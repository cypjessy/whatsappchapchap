...
export const APP_VERSION_CODE = 16; // Must match android/app/build.gradle → versionCode
export const APP_VERSION_NAME = "1.0.15"; // Must match android/app/build.gradle → versionName
